  ...
  const contactDetails = [
    {
      ...
      title: "Our Office",
      details: ["Diepkloof 319-Iq", "Soweto", "Johannesburg", "South Africa"],
    },
    {
      icon: <PhoneIcon sx={{ fontSize: 40, color: "#002244" }} />,
      title: "Phone",
      details: ["+27 78 029 6288"],
    },
    {
      icon: <EmailIcon sx={{ fontSize: 40, color: "#002244" }} />,
      title: "Email",
      details: ["info@malloyagroup.co.za", "support@malloyagroup.co.za"],
    },
    {
      icon: <AccessTimeIcon sx={{ fontSize: 40, color: "#002244" }} />,
      title: "Business Hours",
      details: ["Monday - Friday: 8AM - 5PM", "Saturday: Closed", "Sunday: Closed"],
    },
  ]
...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        // Send email to info@malloyagroup.co.za
